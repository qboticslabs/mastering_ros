...
from std_msgs.msg import String,Float32, Int32,UInt64, Int16
...
#Subscriber for encoders
		self._Left_Encoder_ = rospy.Subscriber('left_encoder',Int16, self._Update_Left_Encoder)


		self._Right_Encoder_ = rospy.Subscriber('right_encoder',Int16, self._Update_Right_Encoder)
...
#			rospy.logwarn("X_POS")
#			rospy.logwarn(self.X_Pos)


#			rospy.logwarn("Y_POS")
#			rospy.logwarn(self.Y_Pos)
...
#			rospy.logwarn(self.Velocity)


#			rospy.logwarn("Omega")
#			rospy.logwarn(self.Omega)
